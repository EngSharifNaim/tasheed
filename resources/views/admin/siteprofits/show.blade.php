    ...
    <div class="portlet light ">
        <div class="portlet-title">
            <div class="caption font-green-haze">
                ...
                <span class="caption-subject bold uppercase"> {{ __('admin.siteprofitsshow') }} <i class="fa fa-angle-right"></i>رقم الطلب :  {{ $siteprofit->id }} / صاحب الطلب : {{ $siteprofit->user->name }} </span>
            </div>
        </div>
        <div class="portlet-title">
            <div class="caption font-green-haze">
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <select name="pay_status" class="form-control" readonly="true" disabled="true">
                                <option value="{{ $siteprofit->status }}" @if( $siteprofit->status == 1 ) selected="true" @endif> {{ __('admin.siteprofitsstatuszero') }} </option>
                                <option value="{{ $siteprofit->status }}" @if( $siteprofit->status  == 0 ) selected="true" @endif> {{ __('admin.siteprofitsstatusone') }} </option>
