                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> {{ __('admin.siteprofitstime') }} </th>
                                                <th> {{ __('admin.siteprofitsdealername') }} </th>
                                                <th> {{ __('admin.siteprofitsphone') }} </th>
                                                <th> {{ __('admin.siteprofitstotal') }} </th>
                                                <th> {{ __('admin.siteprofitsiteprofit') }}</th>
                                                <th> {{ __('admin.siteprofitsstatus') }} </th>
                                        ...
                                        <tbody>
                                            ...
                                            @if($siteprofits)
                                          @foreach($siteprofits as $siteprofit)
                                            <tr class="odd gradeX">
                                                <td>
                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                        <input type="checkbox" class="checkboxes" name="checkboxes[]" value="{{  $siteprofit->id }}" />
                                                        <span></span>
                                                    </label>
                                                </td>
                                                <td> {{ $siteprofit->created_at->diffforhumans() }} </td>
                                                <td>
                                                  {{ $siteprofit->user->name }}
                                                </td>
                                                <td>
                                                  {{ $siteprofit->user->phone }}
                                                ...
                                                <td>
                                                    {{ $siteprofit->site_profit }}
                                                </td>
                                               
                                                <td>
                                                    @if($siteprofit->status ===  0)  {{ __('admin.siteprofitsstatuszero') }} @else {{ __('admin.siteprofitsstatusone') }} @endif
                                                </td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" order="menu">
                                                            <li>
                                                                <a href="{{ URL::to(ADMIN.'/siteprofits') }}/{{ $siteprofit->id }}">
                                                                    <i class="icon-folder"></i> {{ __('admin.show_title') }} </a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ URL::to(ADMIN.'/siteprofits') }}/{{ $siteprofit->id }}/edit">
