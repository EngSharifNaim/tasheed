                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> {{ __('admin.pages_edite_title') }} <i class="fa fa-angle-right"></i> {{ $page->name_ar }} / {{ $page->name_en }} </span>
                                    </div>
                                </div>
                                    ...
                                    <form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/pages') }}/{{ $page->id }}"  enctype="multipart/form-data">
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="parent_id" class="form-control">
                                                            ...
                                                            @foreach ($parents as $parent)
                                                              ...
                                                              <option value="{{ $parent->id }}" @if($parent->id == $page->parent_id) selected @endif>@if(Lang::locale() == 'ar')  {{ $parent->name_ar }} @else  {{ $parent->name_ar }} @endif</option>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="name_ar" name="name_ar"  placeholder="{{ __('admin.pages_name') }}" value="{{ $page->name_ar }}">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="name_en" name="name_en"  placeholder="{{ __('admin.pages_name') }}" value="{{ $page->name_en }}">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="url" name="url"  placeholder="{{ __('admin.pages_url') }}" value="{{ $page->url }}">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="ckeditor form-control" id="description_ar" name="description_ar"  placeholder="{{ __('admin.pages_content') }}">{{ $page->description_ar }}</textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="ckeditor form-control" id="description_en" name="description_en"  placeholder="{{ __('admin.pages_content_en') }}">{{ $page->description_en }}</textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="radio-list">
                                                        ...
                                                        @elseif ($page->page_location == 'help')
                                                            <label class="radio-inline">
                                                                <input type="radio" name="page_location" id="optionsRadios26" value='top_bar'> {{ __('admin.top_bar') }}</label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="page_location" id="optionsRadios27" value='menu' > {{ __('admin.menu') }}</label>
                                                        ...
                                                        @elseif ($page->page_location == 'page_condition_snodd')
                                                            ...
                                                            <label class="radio-inline">
                                                                <input type="radio" name="page_location" id="optionsRadios29" value='page_condition_snodd' checked="true"> {{ __('admin.page_condition_snodd') }}
                                                            </label>   												
                                                        ...
                                                        @else
                                                            ...
                                                            <label class="radio-inline">
                                                                <input type="radio" name="page_location" id="optionsRadios27" value='menu' > {{ __('admin.menu') }}</label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="page_location" id="optionsRadios28" value='footer' checked="true"> {{ __('admin.footer') }}</label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="page_location" id="optionsRadios29" value='contact_page' > {{ __('admin.contact_page') }}
                                                            </label>
                                                            <label class="radio-inline">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" class="ckeditor form-control" id="sorting" name="sorting" value="{{ $page->sorting }}"  placeholder="{{ __('admin.sorting') }}" >
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
