...
<div class="portlet light ">
    <div class="portlet-title">
        <div class="caption font-green-haze">
            ...
            <span class="caption-subject bold uppercase"> {{ __('admin.brands_title_add') }} </span>
        </div>
    </div>
    <div class="portlet-body form">
        ...
        @foreach (['danger', 'warning', 'success', 'info'] as $msg)
            ...
            @endif
        @endforeach
        <form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/brands') }}"  enctype="multipart/form-data">
            <div class="form-body">

                <div class="form-group form-md-line-input">
                    <label class="col-md-2 control-label" for="name">{{ __('admin.brands_name') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" required="required" id="name_ar" name="name_ar"  value="{{ old('name_ar') }}" placeholder="{{ __('admin.brands_name') }}">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" required id="name_en" name="name_en" value="{{ old('name_en') }}"  placeholder="{{ __('admin.brands_name') }}">
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <textarea class="ckeditor form-control" id="description_ar" name="description_ar"   placeholder="{{ __('admin.brands_content') }}">{{ old('description_ar') }}</textarea>
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <textarea class="ckeditor form-control" id="description_en" name="description_en"  placeholder="{{ __('admin.brands_content_en') }}">{{ old('description_ar') }}</textarea>
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <input type="file" required="required" class="form-control" id="image" name="image"  placeholder="{{ __('admin.brands_image') }}">
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <!---choose sections---->
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="md-checkbox-inline">
                            @foreach($sections as $section ) <div class="md-checkbox ">
                                    <input style="padding-bottom:5px ;padding-top:20px  ;" type="checkbox" id="{{ $section->id }}" class="md-check" name="sections[]" value="{{ $section->id }}">
