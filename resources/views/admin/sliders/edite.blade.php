...
@section('head_title')
    ...
    {{ __('admin.sliders_title_edite') }}  <i class="fa fa-angle-right"></i> {{ $slider->name_ar }} / {{ $slider->name_en }}
@stop
@section('content')
...
<div class="portlet light ">
    <div class="portlet-title">
        <div class="caption font-green-haze">
            ...
            <span class="caption-subject bold uppercase"> {{ __('admin.sliders_title_edite') }}  <i class="fa fa-angle-right"></i> {{ $slider->name_ar }} / {{ $slider->name_en }}</span>
        </div>
    </div>
    <div class="portlet-body form">
        ...
        @foreach (['danger', 'warning', 'success', 'info'] as $msg)
            ...
            @endif
        @endforeach
        <form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/sliders') }}/{{ $slider->id }}"  enctype="multipart/form-data">
            <div class="form-body">

                <div class="form-group form-md-line-input">
                    <label class="col-md-2 control-label" for="name">{{ __('admin.sliders_name') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="name_ar" name="name_ar"  placeholder="{{ __('admin.sliders_name') }}" value="{{ $slider->name_ar }}">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="name_en" name="name_en"  placeholder="{{ __('admin.sliders_name') }}" value="{{ $slider->name_en }}">
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10" style="text-align:right">
                        <textarea class="ckeditor form-control cke_contents_rtl " style="text-align:right" id="description_ar" name="description_ar"  placeholder="{{ __('admin.sliders_content') }}">{{ $slider->description_ar }}</textarea>
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10" >
                        <textarea class="ckeditor form-control" id="description_en" name="description_en"  placeholder="{{ __('admin.sliders_content_en') }}">{{ $slider->description_en }}</textarea>
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <input type="file" class="form-control" id="image" name="image"  placeholder="{{ __('admin.sliders_image') }}" >
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="link" name="link" @if(!empty($slider->link)) value="{{ $slider->link  }}"  @endif  placeholder="{{ __('admin.link') }}">
                        <div class="form-control-focus"> </div>
                    </div>
                </div>
                <div class="form-group form-md-line-input">
