...
@section('head_title') {{ __('admin.sliders') }} @stop
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">{{ __('admin.sliders') }}</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ URL::to(ADMIN.'/sliders/create') }}" class="btn sbold green"> {{ __('admin.sliders_title_add') }}
                    ...
                    <form action="{{ URL::to(ADMIN.'/sliders_mass_delete') }}" method='POST'>
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
                        @if (count($errors))
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                            ...
                            <tr>
                                ...
                                <th> {{ __('admin.sliders_name') }}</th>

                                <th> {{ __('admin.sliders_image') }} </th>
                            ...
                            @if($sliders)
                                @foreach($sliders as $slider)
                                    <tr class="odd gradeX">
                                        <td>
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" class="checkboxes" name="checkboxes[]" value="{{  $slider->id }}" />
                                                <span></span>
                                            </label>
                                        </td>
                                        <td>
                                            @if(Lang::locale() == 'ar')
                                                <a href="{{ URL::to(ADMIN.'/sliders') }}/{{ $slider->id }}/edit">{{ $slider->name_ar }} </a>
                                            @else
                                            <a href="{{ URL::to(ADMIN.'/sliders') }}/{{ $slider->id }}/edit">{{ $slider->name_en }} </a>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($slider->photo)
                                                <img src="{{ URL::to('public') }}{{ $slider->photo }}" width="100" height="100">
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-left" page="menu">
                                                    <li>
                                                        <a href="{{ URL::to(ADMIN.'/sliders') }}/{{ $slider->id }}">
