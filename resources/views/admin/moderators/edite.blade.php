                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> {{ __('admin.moderators_edite_title') }} </span>
                                    </div>
                                </div>
                                ...
                                @endforeach
                                    ...
                                    <form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/moderators') }}/{{ $user->id }}"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                          <div class="form-group form-md-line-input">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="name" name="name"  placeholder="{{ __('admin.moderators_name') }}" value="{{ $user->name }}">
