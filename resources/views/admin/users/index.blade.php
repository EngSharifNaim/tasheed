...
@section('head_title') {{ __('admin.menu_users_show') }} @stop
  ...
  <div class="col-md-12">
     ...
     <!-- BEGIN EXAMPLE TABLE PORTLET-->
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="{{ URL::to(ADMIN.'/users/create') }}" class="btn sbold green"> {{ __('admin.menu_users_add') }}
                              ...
                              <form action="{{ URL::to(ADMIN.'/users_mass_delete') }}" method='POST'>
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                        @if (count($errors))
                                        ...
                                        <tbody>
                                          ...
                                          @foreach($users as $user)
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a href="{{ URL::to(ADMIN.'/users') }}/{{ $user->id }}">{{ $user->name }} </a>
                                                </td>
                                                <td>
                                                    {{ $user->email }}
                                                </td>
