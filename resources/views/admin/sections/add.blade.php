                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> {{ __('admin.sections_title_add') }} </span>
                                    </div>
                                </div>
                                ...
                                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                                  ...
                                  @endif
                                @endforeach
                                    <form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/sections') }}"  enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" required="required" id="name_ar" name="name_ar"  value="{{ old('name_ar') }}" placeholder="{{ __('admin.sections_name') }}">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" required id="name_en" name="name_en" value="{{ old('name_en') }}"  placeholder="{{ __('admin.sections_name') }}">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="ckeditor form-control" id="description_ar" name="description_ar"   placeholder="{{ __('admin.sections_content') }}">{{ old('description_ar') }}</textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="ckeditor form-control" id="description_en" name="description_en"  placeholder="{{ __('admin.sections_content_en') }}">{{ old('description_ar') }}</textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="file" required="required" class="form-control" id="image" name="image"  placeholder="{{ __('admin.sections_image') }}">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
