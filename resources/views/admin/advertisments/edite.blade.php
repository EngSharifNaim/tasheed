$advertisment->@extends(ad.'.layouts.app')
@section('head_title')
...
@section('content')
    ...
    <div class="portlet light ">
        ...
        <div class="portlet-body form">
            ...
            @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                ...
                @endif
            @endforeach
            <form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/advertisments') }}/{{ $advertisment->id }}"  enctype="multipart/form-data">
                <div class="form-body">
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="name">{{ __('admin.advertisments_name') }}</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" required="required" id="name_ar" name="name_ar"  value="{{ $advertisment->name_ar }}" placeholder="{{ __('admin.advertisments_name_ar') }}">
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" required id="name_en" name="name_en" value="{{ $advertisment->name_en }}"  placeholder="{{ __('admin.advertisments_name_en') }}">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control"  id="link" name="link" value="{{ $advertisment->link }}"  placeholder="{{ __('admin.advertisments_link') }}">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <textarea class=" form-control" id="adverise_code" name="adverise_code"   placeholder="{{ __('admin.advertisments_code') }}">{{ $advertisment->adverise_code }}</textarea>
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
    ...
    --->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                <input type="text" class="form-control"  value="{{$advertisment->start_date }}" readonly name="start_date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                <input type="text" class="form-control" value="{{$advertisment->end_date }}" name="end_date" readonly>
                                <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
