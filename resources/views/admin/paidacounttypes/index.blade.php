                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">{{ __('admin.paid_acounts_type_title') }}</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="{{ URL::to(ADMIN.'/paidacounttypes/create') }}" class="btn sbold green"> {{ __('admin.paid_acounts_type_add') }}
                              ...
                              <form action="{{ URL::to(ADMIN.'/paidacounttypes') }}" method='POST'>
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                        @if (count($errors))
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <tbody>
                                            ...
                                            @if($paidacounttypes)
                                          @foreach($paidacounttypes as $paidacounttype)
                                            <tr class="odd gradeX">
                                                <td>
                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                        <input type="checkbox" class="checkboxes" name="checkboxes[]" value="{{  $paidacounttype->id }}" />
                                                        <span></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    @if(Lang::locale() == 'ar')
                                                        {{ $paidacounttype->title }}
                                                    @else
                                                    {{ $paidacounttype->title }}
                                                    @endif
                                                </td>
                                                <td>
                                                    @if($paidacounttype->userlevel)
                                                    {{$paidacounttype->userlevel->name_ar}}
                                                        @endif

                                                </td>
                                                <td>
                                                    {{$paidacounttype->month_value}}
                                                </td>

                                                <td>
                                                {{$paidacounttype->year_value}}
                                                </td>
                                                <td> {{ $paidacounttype->created_at->diffforhumans() }} </td>
                                                ...
                                                <ul class="dropdown-menu pull-left" page="menu">
                                                    ...
                                                    <li>
                                                        <a href="{{ URL::to(ADMIN.'/paidacounttypes') }}/{{ $paidacounttype->id }}/edit">
