...
@section('head_title')
	...
	{{ __('admin.questionsandanswers_add') }}
	...
	<div class="portlet light ">
		<div class="portlet-title">
			<div class="caption font-green-haze">
				...
				<span class="caption-subject bold uppercase"> {{ __('admin.questionsandanswers_add') }} </span>
			</div>
		</div>
		<div class="portlet-body form">
			...
			<form class="form-horizontal" role="form" method="post" action="{{ url(ADMIN.'/questionsandanswers') }}"  enctype="multipart/form-data">
				...
				<div class="form-body">
					...
					<div class="form-group form-md-line-input">
						...
						<div class="col-md-10">
							<input type="text" class="form-control" id="name_ar" name="name_ar"  placeholder="{{ __('admin.questionsandanswers_question_name_ar') }}" value="{{ old('name_ar') }}">
					...
					<div class="form-group form-md-line-input">
						...
						<div class="col-md-10">
							<input type="text" class="form-control" id="name_en" name="name_en"  placeholder="{{ __('admin.questionsandanswers_question_name_en') }}" value="{{ old('name_en') }}">
							<div class="form-control-focus"> </div>
						</div>
					</div>
					...
					<div class="form-group form-md-line-input">
						...
						<div class="col-md-10">
							<textarea class="ckeditor form-control" id="description_ar" name="description_ar"  placeholder="{{ __('admin.questionsandanswers_question_answers_ar') }}">{{ old('description_ar') }}</textarea>
							<div class="form-control-focus"> </div>
						</div>
					</div>
					<div class="form-group form-md-line-input">
						...
						<div class="col-md-10">
							<textarea class="ckeditor form-control" id="description_en" name="description_en"  placeholder="{{ __('admin.questionsandanswers_question_answers_en') }}">{{ old('description_en') }}</textarea>
							<div class="form-control-focus"> </div>
						</div>
					</div>
					<div class="form-group form-md-line-input">
