                ...
                @endforeach
                    ...
                    <div class="form-row">
                         <div class="form-group col-md-12">
                            <label for="userlevel">{{ __('site.specialacoutnt') }}  <span style="color: red;">* @if ($errors->has('level')) {{ $errors->first('level') }}     @endif</span> </label>
                            <select  required="true" class="form-control" id="userlevel" name="level"  placeholder="{{ __('site.userlevels_type') }}"  >
						   ...
						   <option value="" > اختر  الفئه</option>							
							...
							@else
								 <option value="{{ $userlevel->slug }}"> {{ $userlevel->name_ar }}</option>
							 @endif
							@endforeach	
							</select>
                        </div> 		
                  ...
                  <div class="form-row"> 
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="gridCheck" required name="agree" value="{{ old('agree') }}" >
            ...
            <div class="col-lg-6" >
                        ...
                        <div class="form-group col-md-12">
                            <label for="company_name_ar" > {{ __('site.company_name_ar') }}<span style="color: red;"> @if ($errors->has('company_name_ar')) {{ $errors->first('company_name_ar') }}     @endif</span> </label>
                                ...
                                <input type="text" class="form-control"  name="company_name_ar" value="{{ old('company_name_ar') }}"  id="company_name_ar" placeholder="{{ __('site.company_name_ar') }}">
                           
                        </div>
                        <div class="form-group col-md-12">
                            <label for="company_name_en" > {{ __('site.company_name_en') }}<span style="color: red;"> @if ($errors->has('company_name_en')) {{ $errors->first('company_name_en') }}     @endif</span> </label>
                            
                                <input type="text" class="form-control" name="company_name_en" value="{{ old('company_name_en') }}" id="company_name_en" placeholder="{{ __('site.company_name_en') }}">
                        ...
                        <div class="form-group col-md-12">
                            <label for="company_phone" >{{ __('site.company_phone') }} <span style="color: red;"> @if ($errors->has('company_phone')) {{ $errors->first('company_phone') }}     @endif</span> </label>
                                ...
                                <input type="number"  name="company_phone" value="{{ old('company_phone') }}" class="form-control" id="company_phone" placeholder=" {{ __('site.company_phone') }}">
                        ...
                        <div class="form-group col-md-12">
                         ...
                         <div class="form-group col-md-12">
                            <label for="commercial_register" >الوصف</span> </label>
                                ...
                                <textarea style="min-height:120px;" type="text" name="describtion"  class="form-control " placeholder="الوصف "> </textarea>
