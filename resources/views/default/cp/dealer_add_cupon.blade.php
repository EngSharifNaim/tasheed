            ...
            <div class="portlet light ">
                <div class="portlet-body">
                    ...
                    @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                        ...
                        @endif
                    @endforeach
                        <form  role="form" method="post" action="{{ url('/acount/save-cupon') }}" >
                            <div class="left-form">
                                <!----min price ------------------->
                              		<!---discount_percentage------------>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" class="form-control" required id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage') }}"  placeholder="200">%
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" class="form-control" required id="discount_monay" name="discount_monay" value="{{ old('discount_monay') }}"  placeholder="200">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                                <!-----end-	<!---start date------------>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            <input type="text" class="form-control" readonly name="start_date" required="true">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            <input type="text" class="form-control" readonly name="end_date" required="true">
                                            <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
                                    ...
                                    <div class="col-md-6">
                                        <select name="product_id" class="form-control input-inline input-medium">
                                            ...
                                            @foreach ($products as $product)
                                                <option value="{{ $product->id }}">@if(Lang::locale() == 'ar') {{ $product->name_ar }} @else {{ $product->name_en }} @endif</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <!-----end---------->	<!----choose cupon for product only------------->
