            ...
            <div class="portlet light ">
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="btn-group">
                                <a href="{{ URL::to('/acount/add-cupon') }}" class="add-to-cart btn btn-default "> {{ __('site.add_cupons') }}
                    ...
                    <form action="{{ URL::to('/products_mass_delete') }}" method='POST'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                            <thead>
                            <tr>
                                <th> {{ __('admin.cupon_code') }} </th>
                                <th> {{ __('admin.cupon_start_date') }} </th>
                                <th> {{ __('admin.cupon_end_date') }} </th>
                            ...
                            @if($cupons)
                                @foreach($cupons as $cupon)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="{{url('edit-cupon/'.$cupon->id.'/edit')}}">
